...
const heroData = {
  ...
  const ctaData = {
    ...
    subtitle: 'La carrera de medicina tiene una duración de 5 años',
    buttonUrl: 'https://serviciopagina.upea.bo//InstitucionUpea/273dd8c8-23b5-438a-8607-ee245c6211cb.pdf',
  ...
  const serviceData = {
    ...
    services: [
      ...
      },
      {
        ...
        index: '07',
        title: 'Odontología',
        subtitle: 'Atención dental especializada',
        link: '#',
      },
      {
        backgroundImage: '/assets/img/service_bg.jpg',
...
const Page = () => {
    ...
    useEffect(() => {
        const fetchData = async () => {
            try {
                // Fetch blog posts
                const blogResponse = await fetch('https://serviciopagina.upea.bo/api/publicacionesAll/9');
                const blogData = await blogResponse.json();
                setBlogPosts(blogData);

                // Fetch videos
                const videoResponse = await fetch('https://serviciopagina.upea.bo/api/VideosAll/9');
    ...
    const ctaData1 = {
        videoLink: firstVideo ? firstVideo.video_enlace : 'https://www.youtube.com/embed/ngK0tRPhm-A',
        videoButtonText: 'VER VIDEO',
        subtitle: 'NUESTROS VIDEOS',
        title: firstVideo ? firstVideo.video_titulo : 'CARRERA DE MEDICINA',
        description: firstVideo ? firstVideo.video_breve_descripcion : 'Descubre más sobre nuestra carrera de medicina',
