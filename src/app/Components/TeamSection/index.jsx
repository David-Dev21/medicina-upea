                  ...
                  <div className="cs_slide" key={index}>
                    ...
                    >
                      ...
                      <Link href={item.link || '#'} className="cs_team_thumbnail">
                        <img 
                          src={`https://serviciopagina.upea.bo/InstitucionUpea/Autoridad/${item.imageUrl}`} 
                          alt="img" 
                          width={306} 
                          height={429} 
                        />
                      ...
                      <div className="cs_team_bio">
                        ...
                        <div className="cs_social_btns cs_style_1">
                          <Link href={item.facebook || '#'} className="cs_center" target="_blank">
                            <i>
                              <FaFacebookF />
                            </i>
                          </Link>
                          <Link href={item.twitter || '#'} className="cs_center" target="_blank">
                            <i>
                              <FaTwitter />
                            </i>
                          </Link>
                          <Link href={item.instagram || '#'} className="cs_center" target="_blank">
                            <i>
                              <FaInstagram />
                            </i>
                          </Link>
